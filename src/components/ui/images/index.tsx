...
import { MdError, MdKeyboardArrowDown, MdKeyboardArrowUp, MdVisibility } from 'react-icons/md';
import { PiCaretDoubleLeft, PiCheck, PiShoppingCartSimple } from 'react-icons/pi';
